...
In the open positions of that project, you will be able to see the following details: total price, PNL (profit and loss), opening price, position type, total purchased, total position spread, ticker amount. Additionally, you can close your position.
...
Fees are charged automatically. To better understand how they work, see our [fees page](/fees).

## Protocol analysis
![Protocol Analysis Image](/images/intro-5.png)
