...
- **HYPE**: Predict that the event will happen. If you're right, you'll earn rewards based on the accuracy of your forecast.
- **FLOP**: Predict that the event won’t happen. If your prediction holds true, you’ll receive rewards proportional to the outcome.
