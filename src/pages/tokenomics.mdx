...
Triad is an onchain prediction market platform that allows users to participate in web3, Yes or No predictions using $TRD.

## Token Overview

- **Total Supply**: 17,537,702.82 TRD
- **Locked Supply**: 12,049,781.625 TRD
- **Circulating Supply**: 5,487,921.195 TRD
- **Token Symbol**: $TRD
- **Blockchain**: Solana
