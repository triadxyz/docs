...
- For each swap of $tTRIAD for NFT, 10,000 $tTRIAD will be burned until a total of 1 million $tTRIAD is burned.

<mark style={{ backgroundColor: 'yellow' }}>
  The swapped NFT goes to a pool managed by the swap program where it will be
  available for future swaps of tokens for NFTs.
</mark>
